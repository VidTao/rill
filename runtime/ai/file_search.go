...
func (t *SearchFiles) Spec() *mcp.Tool {
	return &mcp.Tool{
		...
		Title:       "Search files",
		Description: "Searches for a pattern across files in the Bratrax project. Returns matching file paths, line numbers, and snippets. Use this before read_file to discover which files contain specific content.",
		Meta: map[string]any{
