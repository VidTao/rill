...
Slack **#bugs-feedback** channel is the fastest. If you can include:

- What you were trying to do
- What happened instead
- Browser + OS (e.g., "Chrome on Mac")
- A screenshot or Loom if possible

…we can usually triage and patch within a day or two. Email works too — [support@bratrax.com](mailto:support@bratrax.com).
