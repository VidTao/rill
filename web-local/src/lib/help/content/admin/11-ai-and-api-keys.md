...
If you're setting up the MCP endpoint (to use Bratrax data from Claude Desktop or another MCP-compatible client), that lives one tab over in the **MCP** tab on the same Settings page.
