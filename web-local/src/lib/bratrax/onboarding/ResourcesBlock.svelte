...
<div class="card">
  ...
  <div class="resource">
    ...
    <span>
      ...
      <a href={GETTING_STARTED_URL} target="_blank" rel="noreferrer noopener">getting-started guide</a>
    </span>
  </div>
  ...
  <div class="resource">
    <Sparkles size={18} class="ricon" />
    <button class="link" on:click={() => goto("/canvas/campaign_deep_dive")}>
      Ask Claude in-app
    </button>
  </div>

  <div class="resource muted">
    <Mail size={18} class="ricon" />
    <span>
      Still stuck? Email
