...
{#if visible}
  <div
    class="relative mx-4 mt-4 border border-bratrax-acid/30 border-t-4 border-t-bratrax-acid bg-bratrax-acid/5 px-5 py-4"
  >
    <button
      on:click={dismiss}
      class="absolute right-3 top-3 text-bratrax-text-muted hover:text-bratrax-text-primary"
      aria-label="Dismiss"
    >
    ...
    <h2 class="text-base font-bold text-bratrax-text-headline">
    ...
    <div class="mt-3">
      ...
      <span class="ml-3 font-mono text-[10px] text-bratrax-text-muted">
